...
export default function SupportScreen() {
  ...
  const quickLinks = [
    {
      id: 'safety',
      title: 'Safety Center',
      description: 'Learn about staying safe on SwapSphere',
      icon: 'shield-checkmark-outline',
      route: '/support/safety' as const,
    },
    {
      id: 'terms',
  ...
  const renderQuickLink = (link: typeof quickLinks[0]) => (
    <TouchableOpacity
      ...
      onPress={() => {
        // For now, just show an alert for these routes
        Alert.alert(`${link.title} page coming soon!`);
      }}
      activeOpacity={Interactions.activeOpacity}
    >
      ...
      <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.contactInfo}>
            ...
            <View style={styles.contactItem}>
              ...
              <Text style={styles.contactText}>24/7 AI Support | 9AM-6PM Human Support</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.footer}>
          <Text style={styles.footerText}>
            Can't find what you're looking for? Our AI chat assistant is available 24/7 to help you.
          </Text>
        </View>
      </ScrollView>
    </View>
